...
bool Compare(int a,int b)    // The actual comparator function matching the CompFunctor signature
{
  return a > b;
}

bool Compare2(int a,int b)    // The actual comparator function matching the CompFunctor signature
{
  return a < b;
}
bool test4() {
...
void testHuffMan(){
    CP::priority_queue<HuffMan*,HuffFunctor> q(CompareHuff);
